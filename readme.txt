...
Please do not install this if you are using Product Bundles version 6.4.0+. This plugin requires the official [WooCommerce Product Bundles](https://woocommerce.com/products/product-bundles/) extension to work.
